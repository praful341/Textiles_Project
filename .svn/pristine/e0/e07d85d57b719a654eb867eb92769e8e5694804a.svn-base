        ...
        public void ShowForm_SubReport(string pStrRPTName, int pIntZoom = 120, ReportFolder pEnumReportFolder = ReportFolder.NONE)
        {
            try
            {
                ...
                if (DS != null)
                {
                    if (DS.Tables.Count > 0)
                    {
                        if (pStrRPTName == "Receive_Note_Print")
                        {
                            ...
                            RepDoc.Subreports["Gray_Item_Detail.rpt"].SetDataSource(DS.Tables[1]);
                            RepDoc.Subreports["Receive_Note_Item_Detal_Part1.rpt"].SetDataSource(DS.Tables[2]);
                            RepDoc.Subreports["Receive_Note_Item_Detal_Part2.rpt"].SetDataSource(DS.Tables[3]);
                            RepDoc.Subreports["Receive_Note_Item_Detal_Part3.rpt"].SetDataSource(DS.Tables[4]);
                        }
                        else
                        {
