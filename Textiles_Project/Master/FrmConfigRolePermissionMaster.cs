    ...
    public partial class FrmConfigRolePermissionMaster : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnCopy_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Global.Confirm("Are You Sure You Want To Copy Data ? ", "Mahakal_Consultancy", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.No)
                {
                    return;
                }
                try
